...
Client.prototype.createFactor = function getFactors(account, data, callback) {
  if (!account || !account.href) {
...
Client.prototype.createChallenge = function (factor, callback) {
  if (!factor || !factor.href) {
    throw new Error('Client.createChallenge(factor, callback) must be called with a valid factor object.');
  }
